export const LOOKS = [
  ...
  {
    slug: 'linen-vest-set',
    title: 'The Linen Set for Every Summer Plan',
    category: 'dresses',
    price: '$47.74',
    priceOriginal: null,
    amazon: 'https://amzn.to/4wvpdWE',
    heroImage: '/images/hero-linen-vest-set.jpg',
    productImage: '/images/product-linen-vest-set.jpg',
    productName: "Women's Linen 2 Piece Outfits Summer Vest Suit Sets Wide Leg Pants",
    productDesc: 'Linen vest with button detail + wide-leg trousers, business casual, vacation and work sets',
    story: 'The linen vest set that works from beach to city. Natural linen, structured vest with button detail, wide-leg trousers — the silhouette that reads effortlessly expensive. Wear to the airport, to brunch, to a coastal dinner. The kind of set that photographs beautifully from every angle.',
    tips: [
      { label: 'On Fit', text: 'True to size — the linen has a relaxed but structured fit. The vest has a tailored silhouette that works beautifully tucked or worn open over a simple tee.' },
      { label: 'Styling', text: 'The natural linen color pairs with everything — raffia sandals, woven totes, gold jewelry. Add the crescent hobo bag for the complete coastal editorial look.' },
      { label: 'Day to Night', text: 'Flat raffia sandals for daytime. Swap to blue raffia platforms for evening. The vest alone works as a top with wide-leg denim.' }
    ]
  },
  {
    slug: 'beige-blazer',
  ...
  {
    slug: 'crochet-tote-boho',
    title: 'The Bag Everyone Needs This Summer',
    category: 'bags',
    price: '$24.49',
    priceOriginal: '$29.99',
    amazon: 'https://amzn.to/4uC4s9Y',
    heroImage: '/images/hero-crochet-tote-boho.jpg',
    productImage: '/images/product-crochet-tote-boho.jpg',
    productName: 'Tavaleu Crochet Tote Beach Bags for Women, Mesh Beach Tote Knit Bag',
    productDesc: 'Handwoven crochet mesh tote, boho hobo shoulder bag, summer vacation aesthetic',
    story: 'The crochet tote that photographs like it cost three times as much. Loose mesh weave, the kind of casual that looks entirely intentional. Throw in a towel, a book, sunscreen — it holds everything and still looks editorial. Found on Amazon for under $25.',
    tips: [
      { label: 'On Size', text: 'Generously sized — fits a beach towel, water bottle, and all your essentials. The open mesh means sand falls out easily.' },
      { label: 'Styling', text: 'Pairs perfectly with a linen set or a simple white dress. The natural tan color goes with every warm-weather palette.' },
      { label: 'Care', text: 'Hand wash gently in cold water and reshape while damp. Air dry flat to maintain the shape.' }
    ]
  },
  {
    slug: 'crochet-beach-tote',
    title: 'The Most Beautiful Beach Bag of 2026',
    category: 'bags',
    price: '$27.99',
    priceOriginal: null,
    amazon: 'https://amzn.to/4doKNU0',
    heroImage: '/images/hero-crochet-beach-tote.jpg',
    productImage: '/images/product-crochet-beach-tote.jpg',
    productName: 'Peicees Crochet Beach Bag Purse, Boho Woven Tote with Leak-Proof Lining',
    productDesc: 'Boho woven crochet tote, leak-proof lining, summer vacation travel shoulder bag',
    story: 'A crochet beach bag with a leak-proof lining — finally. Everything the aesthetic tote promises, but actually practical. The cream and brown palette photographs beautifully against sand, stone, and Mediterranean tiles.',
    tips: [
      { label: 'The Practical Detail', text: 'The leak-proof lining means sunscreen bottles, wet swimsuits, and water bottles are no longer a problem. Function meets aesthetic.' },
      { label: 'Styling', text: 'Cream and tan works with everything from white linen to burgundy sets. Add a silk scarf on the handle for the editorial touch.' },
      { label: 'Travel', text: 'Lightweight enough to use as a carry-on personal item. Folds flat when empty.' }
    ]
  },
  {
    slug: 'raffia-hobo-bag',
    title: "The Resort Bag You'll Use Every Day",
    category: 'bags',
    price: '$31.98',
    priceOriginal: null,
    amazon: 'https://amzn.to/4uiUx9i',
    heroImage: '/images/hero-raffia-hobo-bag.jpg',
    productImage: '/images/product-raffia-hobo-bag.jpg',
    productName: 'Herald Handmade Crescent Straw Bag, Summer Beach Hobo Raffia Woven Shoulder Handbag',
    productDesc: 'Handmade crescent raffia hobo bag, woven straw, underarm shoulder handbag',
    story: 'The crescent hobo silhouette is the quiet luxury bag shape of the season. This handmade raffia version — under $32 on Amazon — has the soft sculptural quality of bags that cost ten times more. The kind of bag that makes a simple white dress look like an outfit.',
    tips: [
      { label: 'The Shape', text: 'The crescent hobo sits naturally under the arm, which is the most effortless carry. It reads more elevated than a tote and more relaxed than a structured bag.' },
      { label: 'Styling', text: 'Pairs beautifully with flowing dresses, linen sets, and wide-leg trousers. The natural raffia color complements every warm neutral palette.' },
      { label: 'Care', text: 'Spot clean with a damp cloth. Store stuffed with tissue paper to maintain the crescent shape.' }
    ]
  }
];
